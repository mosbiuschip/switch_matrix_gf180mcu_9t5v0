...
N -6.25 -284.375 -1.875 -284.375 {lab=gated_control}
N -1.875 -284.375 60 -284.375 {lab=gated_control}
...
.param mn_w=24u
.param mp_w=72u"}
C {libs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} 100 -284.375 0 0 {name=x1 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {lab_wire.sym} 140 -284.375 2 0 {name=p14 sig_type=std_logic lab=gated_controlb}
...
C {ipin.sym} -6.25 -284.375 0 0 {name=p6 lab=gated_control}
