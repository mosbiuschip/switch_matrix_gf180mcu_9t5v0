...
N -57.5 -389.375 -7.5 -389.375 {lab=control}
N -140 -130 -100 -130 {
lab=#net1}
N -60 -190 -60 -160 {
lab=T2}
...
N 23.125 -281.875 65 -281.875 {lab=#net2}
N 65 -283.75 65 -281.875 {lab=#net2}
...
C {ipin.sym} -57.5 -389.375 0 0 {name=p3 lab=control}
...
.param mn_w=24u
.param mp_w=72u"}
C {gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} 296.25 -284.375 0 0 {name=x1 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
...
C {lab_wire.sym} -140 -130.625 0 0 {name=p5 sig_type=std_logic lab=gated_control}
...
C {gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} 105 -283.75 0 0 {name=x3 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
