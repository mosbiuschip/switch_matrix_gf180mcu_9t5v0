...
T {when ENABLE is HIGH, clock_gated is low so the PHI_2 is high, holding the SW_matrix FF output strong} 415 800 0 0 0.2 0.2 {layer=10}
...
N 130 640 200 640 {lab=#net5}
N 200 640 200 660 {lab=#net5}
N -150 930 -70 930 {lab=VDDd}
N -150 950 -60 950 {lab=VSSd}
N 130 860 430 860 {lab=#net6}
N 130 820 130 860 {lab=#net6}
N 130 990 130 1030 {lab=#net7}
N -150 840 -40 840 {lab=clock}
N 130 990 200 990 {lab=#net7}
...
N 1370 680 1407.5 680 {lab=#net8}
N 1477.5 680 1510 680 {lab=#net9}
N 1590 680 1672.5 680 {lab=data_out}
N 540 680 570 680 {lab=#net10}
N 550 880 570 880 {lab=#net11}
N 650 680 1190 680 {lab=data_gated}
N 650 880 760 880 {lab=clock_gated}
N 200 660 420 660 {lab=#net5}
N -160 1050 -130 1050 {lab=enable}
...
C {gf180mcu_fd_sc_mcu9t5v0_symbols/inv_4.sym} 610 880 0 0 {name=x1 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {gf180mcu_fd_sc_mcu9t5v0_symbols/inv_4.sym} 610 680 0 0 {name=x3 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {lab_wire.sym} 760 680 0 0 {name=p4 sig_type=std_logic lab=data_gated}
C {lab_wire.sym} 750 880 0 0 {name=p5 sig_type=std_logic lab=clock_gated}
