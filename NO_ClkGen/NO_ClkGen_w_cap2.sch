...
N 850 140 880 140 {lab=#net1}
N 880 140 880 150 {lab=#net1}
N 1090 200 1090 210 {lab=VSSd}
N 1050 140 1090 140 {lab=#net2}
...
C {symbols/cap_nmos_03v3.sym} 880 180 0 0 {name=Cloadbot[1:20]
W=1e-6
L=1e-6
model=cap_nmos_03v3
spiceprefix=X
m=8}
C {symbols/cap_nmos_03v3.sym} 1090 170 0 0 {name=Cloadtop[1:20]
W=1e-6
L=1e-6
model=cap_nmos_03v3
spiceprefix=X
m=8}
C {res.sym} 820 140 1 0 {name=Rcapbot[1:20]
value=1k
footprint=1206
device=resistor
m=1}
C {res.sym} 1020 140 1 0 {name=Rcaptop[1:20]
value=1k
footprint=1206
device=resistor
m=1}
