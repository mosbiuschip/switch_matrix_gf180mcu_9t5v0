...
N -30 25 -10 25 {lab=enable}
N 70 25 100 25 {lab=#net7}
N 180 25 210 25 {lab=#net8}
N 290 25 320 25 {lab=#net9}
N 1012.5 15 1143.125 15 {lab=pin}
N 1010 -5 1143.125 -5 {lab=BUS[1:25]}
N 400 25 715 25 {lab=#net10}
N 715 17.5 715 25 {lab=#net10}
...
C {switch_matrix_gf180mcu_9t5v0/swmatrix_Tgate/swmatrix_Tgate.sym} 865 5 0 0 {name=xTgates[1:25]}
...
C {ipin.sym} -29.375 25 0 0 {name=p15 lab=enable

}
C {gf180mcu_fd_sc_mcu9t5v0_symbols/inv_8.sym} 140 25 0 0 {name=x2 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {gf180mcu_fd_sc_mcu9t5v0_symbols/inv_4.sym} 30 25 0 0 {name=x3 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {gf180mcu_fd_sc_mcu9t5v0_symbols/inv_12.sym} 250 25 0 0 {name=x6 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {gf180mcu_fd_sc_mcu9t5v0_symbols/inv_20.sym} 360 25 0 0 {name=x8 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {lab_pin.sym} 520 25 0 0 {name=p11 sig_type=std_logic lab=enable_buf}
