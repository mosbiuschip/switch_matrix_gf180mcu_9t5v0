...
N 310.625 -190 420.625 -190 {lab=Q[1:24],D_out}
...
C {switch_matrix_gf180mcu_9t5v0/ShiftReg_row_25/ShiftReg_row_25.sym} 160.625 -170 0 0 {name=xSR}
C {iopin.sym} 438.125 -30 0 0 {name=p1 lab=pin}
C {switch_matrix_gf180mcu_9t5v0/swmatrix_Tgate/swmatrix_Tgate.sym} 160.625 -40 0 0 {name=xTgates[1:25]}
C {ipin.sym} -69.375 -150 0 0 {name=p2 lab=PHI_2
}
C {ipin.sym} -69.375 -170 0 0 {name=p3 lab=PHI_1
}
C {lab_wire.sym} 320.625 -190 0 1 {name=p4 sig_type=std_logic lab=Q[1:24],D_out}
